...
export const config: Config = {
	...
	professionalSummary:
		"Software engineer with 8+ years of experience building full-stack applications. Marine Corps veteran who has led technical efforts and delivered production systems. Currently building a SaaS platform for American Legion posts to improve digital presence and member engagement.",
	...
	workExperience: [
		{
			...
			endDate: "Present",
			bullets: [
				"Founded and shipped a B2B SaaS platform for American Legion Posts, growing to 23 paying customers ($345 MRR, $5,562 total revenue) across 151 registered organizations, and securing an official partnership with American Legion Headquarters",
